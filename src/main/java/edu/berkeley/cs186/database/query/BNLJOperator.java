...
public class BNLJOperator extends JoinOperator {
  ...
  public int estimateIOCost() throws QueryPlanException {
    float f = this.numBuffers - 2;
    double ceil = Math.ceil(this.getLeftSource().getStats().getNumPages() / f);
    return (int) ((ceil * this.getRightSource().getStats().getNumPages()) + this.getLeftSource().getStats().getNumPages());
  }
