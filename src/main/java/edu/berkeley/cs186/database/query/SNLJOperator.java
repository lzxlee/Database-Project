...
public class SNLJOperator extends JoinOperator {
  ...
  public int estimateIOCost() throws QueryPlanException {
    try{
      return (this.getLeftSource().getStats().getNumRecords()/this.getLeftSource().getStats().getNumPages() * this.getLeftSource().getStats().getNumPages()) * this.getRightSource().getStats().getNumPages() + this.getLeftSource().getStats().getNumPages();
